...
class PayableTest extends TestCase
{
    ...
    public function testValidationErrorWhenCreatingAPayable()
    {
        ...
        $data = [
            ...
            'value'                 => 'Invalid value',
            'installment'           => 'On',
            'installments_number'   => 'Invalid number',
            'installment_value'     => 'Invalid value',
        ...
        $message_installments_number    = __('validation.numeric', ['attribute' => 'installments number']);
        $message_installments_value     = __('validation.numeric', ['attribute' => 'installment value']);
    ...
    public function testGetPayablessWithUnauthenticatedUser()
    {
